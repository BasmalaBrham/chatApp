                            ...
                            <div class="hide-scrollbar">
                                ...
                                <div class="container py-8">
                                    ...
                                    <div class="card-list">
                                        ...
                                        @endphp
                                        <!-- Card -->
                                        <a href="{{ route('chat'),$chat->id }}" class="card border-0 text-reset">
                                            <div class="card-body">
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-online">
                                                            <span class="avatar-text">{{strtoupper(substr($otherParticipant->name,0,1))}}</span>
                                                        </div>
                                                    </div>

                                                    <div class="col">
                                                        <div class="d-flex align-items-center mb-3">
                                                            <h5 class="me-auto mb-0">{{ $otherParticipant->name  }}</h5>
                                                            <span class="text-muted extra-small ms-2">{{ $chat->lastMessage->created_at->difforHumans() }} PM</span>
                                                        </div>
                        ...
                        <div class="chat-body hide-scrollbar flex-1 h-100">
                            <div class="chat-body-inner">
                                <div class="py-6 py-lg-12">
                                    ...
                                    <!-- Message -->
                                    <div class="message @if($message->user_d==Auth::id()) message-out @endif">
                                        ...
                                        <div class="message-inner">
                                            ...
                                            <div class="message-footer">
                                                <span class="extra-small text-muted">{{ $message->created_at->difforHumans() }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
